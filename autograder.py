...
def readCommand(argv):
    ...
    parser.add_option('--test-directory',
                      dest='testRoot',
                      default='test_cases',
                      help='Root test directory containing subdirectories for each question')
    ...
    parser.add_option('--generate-solutions',
                      ...
                      action='store_true',
                      help='Write generated solutions to .solution file')
...
ERROR_HINT_MAP = {
    'q1': {
      ...
      This may be from assuming a certain number of successors or actions.
    ...
    'q3': {
        ...
        This may be from assuming a fixed size or structure of the state space.
        Try making your code more general and submit again!
    """
    }
}
...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP,
             edxOutput=False, muteOutput=False, printTestCase=False, questionToGrade=None):
    import testParser
    import testClasses
    for module in moduleDict:
        setattr(sys.modules[__name__], module, moduleDict[module])
